export default function About() {
  return (
    <div className="max-w-4xl mx-auto pt-10">
      <p>
        My name is Steve Jones, I am a software developer based in the UK. My
        journey into the software development world started in 2019 when I began
        learning Python on a Raspberry Pi while studying for my teaching degree.
        By the time I graduated in 2020, my interest in coding and the endless
        possibilities it provides for solving problems and simplifying peoples
        lives had eclipsed my interest in teaching. So began my search for an
        entry level role.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        Thank you for taking the time to visit my website. While you are here,
        please take a look at my latest posts.
      </p>
    </div>
  );
}
